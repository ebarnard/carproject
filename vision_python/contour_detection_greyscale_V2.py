...
while True:
    ...
    print("morphology time delay:", time_delay)
    ...
    time_delay = timer() - time_start
    print("floodFill time delay:", time_delay)
    ...
    time_delay = timer() - time_start
    print("morphology 2 time delay:", time_delay)
    ...
    time_delay = timer() - time_start
    print("addWeighter + threshold time delay:", time_delay)

    image_use = image_use * (track < 240)

    time_start = timer()

    image_use = cv2.medianBlur(image_use, 3)

    time_delay = timer() - time_start
    print("medianBlur time delay:", time_delay)
    ...
    time_delay = timer() - time_start
    print("findContours time delay:", time_delay)
